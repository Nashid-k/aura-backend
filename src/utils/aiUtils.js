...
export function buildSystemPrompt(habits, summary, insights, moodContext, userPersona = 'maya') {
...
export async function generateWeeklyReflection(habits, summary) {
...
export function buildNudgePrompt(habits, summary) {
